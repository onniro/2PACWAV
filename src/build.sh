...
LIB_DIRS="-L$BASEDIR/3rd_party/SDL2 -L$BASEDIR/3rd_party/codecs/lib"
OBJ_FILES=""
LINK_LIBS="-l:libSDL2.a -lm -lGL $SDL_DIR/lib/libSDL2_mixer.so $SDL_DIR/lib/libSDL2_mixer.a $BASEDIR/lib/libnuklear_sdl2_gl2.a"
WARNINGS="-Wall -Wpedantic -Wno-pointer-arith -Wno-unused-variable -Wno-unused-function -Wno-unused-but-set-variable -Wno-write-strings -Wno-format-contains-nul"
