...
static void spectrum_apply_window(Complex32 *inbuf_complex, 
                                    float *inbuf_real,
                                    int num_iters)
{
...
static void spectrum_squash(Complex32 *post_fft_outbuf, 
                                float *real32_outbuf,
                                int num_bins,
                                int bins_per_point,
...
static void spectrum_fill_verts_lineseg(float *verts, 
                                            int num_elements,
                                            int num_primitives,
                                            Runtime_Vars *rtvars,
                                            Sdl_Apidata *sdldata)
...
static void spectrum_fill_verts_point(float *verts, 
                                        int num_elements,
                                        int num_primitives,
                                        Runtime_Vars *rtvars,
                                        Sdl_Apidata *sdldata)
